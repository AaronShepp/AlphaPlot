...
# ---------- Species list ----------
LISTS = {
"LIST1": ["Sorbus torminalis", "Taxus baccata", "Acer campestre", "Tilia platyphyllos"],
"LIST2": ["Sorbus torminalis", "Taxus baccata", "Pinus nigra", "Prunus avium"],
"LIST3": ["Acer campestre", "Tilia platyphyllos", "Pinus nigra", "Prunus avium"],
"LIST4": ["Sorbus torminalis", "Taxus baccata", "Acer campestre", "Tilia platyphyllos", "Pinus nigra", "Prunus avium"]
}
